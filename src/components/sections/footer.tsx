      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-12">
        ...
        <div className="grid grid-cols-2 gap-8 pb-16 lg:grid-cols-4 lg:gap-12">
          ...
          <div className="order-1 lg:order-4">
            ...
            <ul className="space-y-3 text-[13px] text-stone-400">
              <li>Zuidas, {company.address}</li>
              <li>{company.postcode} {company.city}</li>
              <li className="pt-2">
                <a href={`tel:+${company.phone_raw}`} className="transition-colors hover:text-white">
                  {company.phone}
                </a>
              </li>
              <li>
        ...
        <div className="flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-8 sm:flex-row">
          <p className="text-[12px] text-stone-500">
            &copy; {new Date().getFullYear()} {company.name}. {footer_ui.copyright}
          </p>
